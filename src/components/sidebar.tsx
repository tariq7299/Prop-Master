  ...
  return (
    ...
    >
      ...
      <Layout fixed className={navOpened ? 'h-svh' : ''}>
        ...
        <Layout.Header
          sticky
          className='z-40 flex justify-between px-4 py-3 shadow-sm md:px-4 '
        >
          {isCollapsed
            ? (
        ...
        <Nav
          id='sidebar-menu'
          className={`z-40 h-full flex-1 overflow-auto font-roboto-slap  ${navOpened ? 'max-h-screen' : 'max-h-0 py-0 md:max-h-screen md:py-2'}`}
        ...
        <Button
          ...
          size='icon'
          variant='outline'
          className='absolute -right-5 top-1/2 z-40 hidden rounded-full md:inline-flex'
        >
          <IconChevronsLeft
            stroke={1.5}
